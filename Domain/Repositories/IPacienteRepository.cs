...
public interface IPacienteRepository
{
    ...
    Task<Result<Paciente>> FindByIdTrackingAsync(int id, CancellationToken ct = default);
    ...
    Task<Result<Paciente>> FindByIdAndProfissionalTrackingAsync(int id, int profissionalId, CancellationToken ct = default);
